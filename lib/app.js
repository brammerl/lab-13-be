...
app.get('/api/breweries/:postal', async(req, res) => {
  console.log(req.params.postal);
  // receive params of request
  const data = await request.get(`https://api.openbrewerydb.org/breweries?by_postal=${req.params.postal}`);
